 ...
 50         CONTINUE
      ...
      !
      RETURN
 1000 FORMAT(' Generalized Minimum Residual(',I3,I3,') for ', 'N, ITOL = ',I5, I5,           'N, ITOL = ',I5, I5,&
           /' ITER','   Natural Err Est','   Error Estimate')
 1010 FORMAT(1X,I4,1X,D16.7,1X,D16.7)
 1020 FORMAT(1X,' ITER = ',I5, ' IELMAX = ',I5, ' |R(IELMAX)/X(IELMAX)| = ',D12.5)           ' |R(IELMAX)/X(IELMAX)| = ',D12.5)
